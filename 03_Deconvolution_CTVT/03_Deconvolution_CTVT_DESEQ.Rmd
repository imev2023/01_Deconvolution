...
curatedCib50 <- cibersortDictMin50 %>%
  filter(GeneID != intersect(resTypeDegs$GeneID, cibersortDictMin50$GeneID))
...
intersect(resTypeOverallDegs$GeneID, cibersortDictMin50$GeneID)

curatedCib50 <- cibersortDictMin50 %>%
  filter(GeneID != intersect(resTypeOverallDegs$GeneID, cibersortDictMin50$GeneID))

curatedCib50Unique <- cibersortUniqueDictMin50 %>%
  filter(GeneID != intersect(resTypeOverallDegs$GeneID, cibersortUniqueDictMin50$GeneID))
```
